class DrumKit{
    constructor(){
        ...
        this.temploSlider = document.querySelector('.tempo-slider');
    }
...
drumKit.temploSlider.addEventListener('input', function(event){
    drumKit.changeTempo(event);
})

drumKit.temploSlider.addEventListener('change', function(event){
